...
_NUMBERREQUEST = _descriptor.Descriptor(
  name='NumberRequest',
  full_name='helloworld.NumberRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='number', full_name='helloworld.NumberRequest.number', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_NUMBERREPLY = _descriptor.Descriptor(
  name='NumberReply',
  full_name='helloworld.NumberReply',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='helloworld.NumberReply.message', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
NumberReply = _reflection.GeneratedProtocolMessageType('NumberReply', (_message.Message,), dict(
  ...
  __module__ = 'helloworld_pb2'
  # @@protoc_insertion_point(class_scope:helloworld.NumberReply)
  ))
...
_GREETER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='SayNumber',
    full_name='helloworld.Greeter.SayNumber',
    index=2,
    containing_service=None,
